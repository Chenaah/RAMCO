from .scratch_itch import ScratchItchEnv, ScratchItchX

class ScratchItchPR2Env(ScratchItchEnv):
    def __init__(self):
        super(ScratchItchPR2Env, self).__init__(robot_type='pr2', human_control=False)

class ScratchItchPR2X(ScratchItchX):
    def __init__(self):
        super(ScratchItchPR2X, self).__init__(robot_type='pr2', human_control=False)
