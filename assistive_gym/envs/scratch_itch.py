...
class ScratchItchX(AssistiveEnv):
    def __init__(self, robot_type='pr2', human_control=False):
        super(ScratchItchX, self).__init__(robot_type=robot_type, task='scratch_itch', human_control=human_control, frame_skip=5, time_step=0.02, action_robot_len=7, action_human_len=(10 if human_control else 0), obs_robot_len=33, obs_human_len=(34 if human_control else 0))
    ...
    def step(self, action):
        ...
        obs = np.concatenate([obs,[tool_force_at_target], [reward_force_scratch],[preferences_score]])
    ...
    def reset(self):
        ...
        return np.concatenate([orig,[tool_force_at_target], [0],[preferences_score]])
